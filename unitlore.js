    ...
    if (value['lore']) {
      if (value['lore']['rare'].length > 0) {
        for (var item = 0; item < value['lore']['story'].length; item++) {
          ...
          loreTOP += '<div class="col-md-2 unit_img"><a href="#imageModal" data-toggle="modal" data-img-url="' + imgPrePath + 'unit/img/unit_ills_full_' + value['ids'][item] + '.png"><img src="' + imgPrePath + 'unit/img/unit_ills_full_' + value['ids'][item] + '.png" style="width: 95%; display: block; margin-left: auto; margin-right: auto;"></a></div>';
