  ...
  "Nalmika": {
    ...
    "lore": {
      ...
      "story": [
        ...
        "A goddess that was once imprisoned for having committed a grave crime. She planted her carnivorous plants in the lands she had conquered, steadily helping to reduce the human population in those areas and resulting in Atharva Republic entrusting <span class='pseudolink' onclick=searchName('Emilia')>Goddess Emilia</span> with her subjugation. However, Nalmika had grown too powerful thanks to all the surrounding land in her control and ultimately made a fool out of Emilia in battle. At that moment, a <span class='pseudolink' onclick=searchName('Eze')>man</span> screaming in a loud voice defended Emilia from her predicament, and Nalmika ended up leaving the battlefield disinterested in such disruptions."
      ]
    },
    "related": [
      "<span class='pseudolink' onclick=searchBatch('Fallen_Gods')>Fallen Gods</span>",
